...
const Footer = () => {
    return (
        <footer className='-z-20 w-full relative md:h-screen bg-black text-white bg-fixed px-5 overflow-hidden'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between pt-8 md:pt-20 md:px-21 w-full h-60 md:items-end'>
                ...
                <div className='text-lg md:text-2xl flex flex-col space-y-5 my-10 md:my-0'>
                    ...
                    <input type="text" className='z-10 border rounded px-2 py-2 border-white md:w-100 pl-2 text-lg' placeholder='Email address' />
                </div>
            </div>

            <div className='pt-10 w-full h-fit'>
                <h2 className='text-8xl pt-20 md:pt-0 md:text-[19vw] leading-tight font-extrabold text-center'>Sundown</h2>
                <hr className='my-10 md:my-0' />
            </div>

            <div className='flex flex-col md:flex-row md:justify-between text-lg md:text-lg py-5 px-2'>
            ...
            {/* Animations */}
            <div className='-z-10 absolute hidden md:block top-[-50%] left-[-20%] w-[90%] h-[90%] bg-[#fe330a] blur-[50px] animate-shap1'></div>
